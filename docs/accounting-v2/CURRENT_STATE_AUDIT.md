...
Historical WP00 snapshot. PR #94 merged on 2026-09-18; current execution is UI-02A (see [CURRENT_STATUS](../launch/CURRENT_STATUS.md) and DEC-010). The audit below retains its original code/runtime evidence date.
