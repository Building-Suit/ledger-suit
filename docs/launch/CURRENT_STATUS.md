...
- Work branch: `codex/wp00-planning-bootstrap`; isolated `/home/tareq/Dev/ledger-suit-wp00`. WP00 publication authorized by the founder on 2026-09-18: commit/push this documentation branch and open a PR targeting dev. Independent review remains pending.
