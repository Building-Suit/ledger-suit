...
- Full local Chromium E2E: **56/56 PASS**, including the earlier invitation scenario; live exact-head application and database/Edge/E2E results are tracked at [PR #96 checks](https://github.com/Building-Suit/ledger-suit/pull/96/checks). Existing RISK-014 remains open regardless of a subsequent green run; its earlier invitation timeout cause is not established.
