import { d as DevframeRpcConnection, n as WsOriginRegistry, u as DevframeNodeRpcSessionMeta } from "../ws-server-Di2oqr4q.mjs";
import { Ct as DevframeAuthHandler, F as DevframeDefinition, G as McpRouteOptions, U as DevframeSseOptions, W as DevframeWsOptions, bt as DevframeStorageScope, o as DevframeNodeContext, s as DevframeNodeRpcSession, t as ConnectionMeta } from "../context-BhBzOXVa.mjs";
import { o as StaticAssetsSource } from "../remote-assets-B13_vRkJ.mjs";
import { c as StartedServer, f as DevframeInstanceRecord } from "../instance-shell-Bh4l9Vz_.mjs";
import { Buffer } from "node:buffer";
import { IncomingMessage, Server, ServerResponse } from "node:http";
import { Duplex } from "node:stream";
import { H3 } from "h3";
//#region src/adapters/initiate.d.ts
interface InitDevframeOptions {
  /**
 ...
 * @internal
 */
interface DevframeInstanceInternals {
...
/** @internal */
declare function getInstanceInternals(handler: object): DevframeInstanceInternals;
/**
 ...
 */
declare function initDevframe(def: DevframeDefinition, options: InitDevframeOptions): DevframeInstance;
//#endregion
export { DevframeInstance, DevframeInstanceInternals, InitDevframeOptions, getInstanceInternals, initDevframe };