...
function _resolve(id, options = {}) {
	if (typeof id !== "string") {
		if (id instanceof URL) id = fileURLToPath$1(id);
...
//#endregion
//#region node_modules/.pnpm/@eslint+config-array@0.23.5_patch_hash=9c56839266cb75a04e2a96a342456c69afd7549bf6c13a9a_cff8e52b73e7cdbd19acb9ff92c724c1/node_modules/@eslint/config-array/dist/esm/std__path/posix.js
...
*/ function relative$1(from, to) {
	...
	let out = "";
	for (i = fromStart + lastCommonSep + 1; i <= fromEnd; ++i) if (i === fromEnd || isPosixPathSeparator$1(from.charCodeAt(i))) {
		if (out.length === 0) out += "..";
		else out += "/..";
	}
...
//#endregion
//#region node_modules/.pnpm/@eslint+config-array@0.23.5_patch_hash=9c56839266cb75a04e2a96a342456c69afd7549bf6c13a9a_cff8e52b73e7cdbd19acb9ff92c724c1/node_modules/@eslint/config-array/dist/esm/std__path/windows.js
...
*/ function relative(from, to) {
	...
	for (i = fromStart + lastCommonSep + 1; i <= fromEnd; ++i) if (i === fromEnd || from.charCodeAt(i) === CHAR_BACKWARD_SLASH) {
		if (out.length === 0) out += "..";
		else out += "\\..";
	}
...
//#endregion
//#region node_modules/.pnpm/debug@4.4.3_supports-color@10.1.0/node_modules/debug/src/common.js
...
//#endregion
//#region node_modules/.pnpm/debug@4.4.3_supports-color@10.1.0/node_modules/debug/src/browser.js
...
//#endregion
//#region node_modules/.pnpm/debug@4.4.3_supports-color@10.1.0/node_modules/debug/src/node.js
...
//#endregion
//#region node_modules/.pnpm/@eslint+config-array@0.23.5_patch_hash=9c56839266cb75a04e2a96a342456c69afd7549bf6c13a9a_cff8e52b73e7cdbd19acb9ff92c724c1/node_modules/@eslint/config-array/dist/esm/index.js
/**
...
* @type {Set<string>}
*/
const META_FIELDS = /* @__PURE__ */ new Set([
	"name",
	"basePath",
	"index"
]);
...
function normalizeConfigPatterns(config, namespacedBasePath, path) {
	...
	if (hasBasePath) {
		if (path.isAbsolute(config.basePath)) newConfig.basePath = path.toNamespacedPath(config.basePath);
...
async function readConfig(options) {
	...
	if (hookSupported) {
		...
		const scope = {
			basePath,
			realBasePath,
			deps: /* @__PURE__ */ new Set([configPath])
		};
...
async function collectStaticDependencies(jiti, configPath) {
	const visited = /* @__PURE__ */ new Set([configPath]);
