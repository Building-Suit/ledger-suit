...
test('launch pricing is responsive, accurate, and distinguishes included from future features', async ({ page }) => {
  ...
  await expect(pricing.locator('[data-plan="solo"]')).toContainText('EGP 271.32/month · billed EGP 3,255.84 yearly')
  ...
  await expect(pricing.locator('[data-plan="starter"]')).toContainText('EGP 407.32/month · billed EGP 4,887.84 yearly')
  ...
  await expect(pricing.locator('[data-plan="business"]')).toContainText('EGP 747.32/month · billed EGP 8,967.84 yearly')
