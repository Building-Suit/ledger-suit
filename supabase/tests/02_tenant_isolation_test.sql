...
select app.seed_chart_of_accounts((select id from ids where key = 'org_a'));
select app.seed_categories((select id from ids where key = 'org_a'));
set local role authenticated;
...
select app.seed_chart_of_accounts((select id from ids where key = 'org_b'));
select app.seed_categories((select id from ids where key = 'org_b'));
set local role authenticated;
